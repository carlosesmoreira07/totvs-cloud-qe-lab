...
- O escopo do laboratório está consolidado: LAB-01 a LAB-12 e AI-01 a AI-07 (LAB SCOPE COMPLETE). Não antecipe DAST ativo, pentest, IAM fictício, Kubernetes, ambientes reais, auto-remediação, RAG, embeddings ou vector database.
